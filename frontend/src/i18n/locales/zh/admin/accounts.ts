export default {
    accounts: {
      ...
      cursor: {
        ...
        accessTokenHint: '若包含 userId:: 前缀，只会保存 :: 之后的 JWT。',
        accessTokenRequired: '请粘贴 Cursor access token',
        accessTokenKeep: '留空则保留当前 access token',
        refreshToken: 'Refresh token',
        refreshTokenPlaceholder: '粘贴 refresh token（建议填写）',
        refreshTokenHint: '建议填写，以便 access token 过期后可以刷新。',
        refreshTokenKeep: '留空则保留当前 refresh token',
        machineId: 'Machine ID',
        machineIdPlaceholder: 'telemetry.machineId 的 64 位十六进制',
        machineIdHint: 'storage.json → telemetry.machineId。不要使用 storage.serviceMachineId。',
        machineIdRequired: '请粘贴 telemetry.machineId（64 位十六进制）',
        machineIdInvalid: 'Machine ID 必须是 64 位十六进制（telemetry.machineId）',
        macMachineId: 'Mac Machine ID',
        macMachineIdPlaceholder: 'telemetry.macMachineId 的 64 位十六进制',
        macMachineIdHint: 'storage.json → telemetry.macMachineId。',
        macMachineIdRequired: '请粘贴 telemetry.macMachineId（64 位十六进制）',
        macMachineIdInvalid: 'Mac Machine ID 必须是 64 位十六进制（telemetry.macMachineId）',
        clientVersion: '客户端版本',
        clientVersionPlaceholder: '3.16.17',
        clientVersionHint: '对应 x-cursor-client-version。留空时默认 3.16.17。',
        modelRestrictionHint: '可选。按该账号实时拉取的 Cursor picker 过滤或映射请求模型。留空表示允许全部 picker 模型。'
      },
      anthropic: {
      ...
      cursorStaticFallbackUsed: '无法获取 Cursor 实时模型列表，已填入 {count} 个静态回退模型。若请求被映射到回退 slug，API 会返回警告。',
